...
class APPOServerlessConfig(ImpalaConfig):
    """Defines a configuration class from which an APPO Algorithm can be built.

    .. testcode::

        from ray.rllib.algorithms.appo import APPOServerlessConfig
        config = APPOServerlessConfig().training(lr=0.01, grad_clip=30.0, train_batch_size=50)
    ...
    def __init__(self, algo_class=None):
        """Initializes a APPOServerlessConfig instance."""
        super().__init__(algo_class=algo_class or APPOServerless)
...
class APPOServerless(Impala):
    def __init__(self, config, *args, **kwargs):
        """Initializes an APPOServerless instance."""
