...
class AlgorithmConfig(_Config):
    ...
    def __init__(self, algo_class=None):
        ...
        # Async learn
        self.algo_name = None
        self.num_async_learners = 4
        self.async_learn = False
        self.num_async_return_min = 1
        self.async_timeout = 0.1
        self.result_timeout = 0.1
        self.serverless_bound = 114514
        self.serverless_decay = 0.95
        self.serverless_is_ratio = 1.0
        self.serverless_lr_smooth = 3

        self.redis_host = False
        self.redis_port = False

        self.use_weighted_grads = False
        self.use_is_truncation = False
    ...
    def thaw(self):
        """Thaw this config object"""
        if self._is_frozen is False:
            return
        self._is_frozen = False

        # Also thaw underlying eval config, if applicable.
        if isinstance(self.evaluation_config, AlgorithmConfig):
            self.evaluation_config.thaw()
